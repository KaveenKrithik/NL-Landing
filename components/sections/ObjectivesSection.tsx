...
const objectives = [
    {
        ...
        description: "Establishing and administering schools (English & Tamil medium), colleges, libraries, and hostels across urban and rural areas.",
        color: "bg-blue-100",
    ...
    },
    {
        ...
        description: "Providing full scholarships, uniforms, transportation, meals, and educational materials to meritorious and economically underprivileged students.",
        color: "bg-cyan-100",
    ...
    },
    {
        ...
        description: "Promoting adult education and digital literacy specifically in tribal and remote areas to bridge knowledge gaps.",
        color: "bg-orange-100",
