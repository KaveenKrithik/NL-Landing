              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:border-accent transition-colors">
                    ...
                    <option value="donation" className="bg-navy">
                      Donation Inquiry
                    </option>
                    <option value="volunteer" className="bg-navy">
                      Volunteer Opportunities
                    </option>
                    <option value="partnership" className="bg-navy">
                      Corporate Partnership
                    </option>
                    <option value="program" className="bg-navy">
                      Program Information
                    </option>
