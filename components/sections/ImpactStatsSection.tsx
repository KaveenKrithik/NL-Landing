...
const stats = [
  ...
  },
  {
    ...
    suffix: "+",
    label: "Medical Camps",
    description: "Free healthcare and treatment assistance",
  },
  {
    value: 500,
    suffix: "+",
    label: "Women Trained",
    description: "Vocational training for women & youth",
  },
  {
    value: 100,
    suffix: "%",
    label: "Transparency",
    description: "Audited accounts and governance",
  },
];
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Every initiative represents lives transformed through education,
